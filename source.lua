            -- // Cheat
            local CheatTable = {
                Library = loadstring(fluxus.request({Url = "https://raw.githubusercontent.com/MOTwrrt/pf.lol/main/new_hyphon_ui.lua"; Method = "GET"}).Body)();
                Visuals = loadstring(fluxus.request({Url = "https://raw.githubusercontent.com/MOTwrrt/pf.lol/main/esp.lua"; Method = "GET"}).Body)();
                Connections = {};
                Measurements = {};
            };
